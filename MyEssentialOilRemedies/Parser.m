...
/*! @brief intialize the Oils with a pre set File and Path
...
/*! @brief intialize the Remedy with a pre set File and Path
    Mostly used for testing, but you can also set the Directory/InBox to the path to use for production
 */
-initRemedy {
    if(self == [super init]) {
...
/*! @brief Pass the Path of the file to process to intialize the class
 */
...
/*! @brief Get the Elemenents from the XML Data source
 */
...
/*! @brief find the end of the elemenent and display the value of that element
...
/*! @brief Append to string when a value was found
 */
...
/*! @brief Set the Class Global Variables to the values that is in the XML dataset to be used outside of this class
    @remark This is a Private Sub
 */
...
/*! @brief A simple Private class to help format the XML Elements as needed for XML Files.
...
/*! @brief Format the values passed to this function to be put into XML Format for Oils
 */
...
/*! @brief Format the values passed to this function to be put into XML Format for Remedies
 */
...
/*! @brief Release objects form memory
 */
-(void) releaseObjects
{
    _databasePath = nil;
